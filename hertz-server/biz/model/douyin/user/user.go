...
type UserRequest struct {
	...
	// 发送请求的用户的id
	ActorID int32 `thrift:"actor_id,2" form:"actor_id" json:"actor_id" query:"actor_id"`
}
...
func (p *UserRequest) GetUserID() (v int32) {
	return p.UserID
}

func (p *UserRequest) GetActorID() (v int32) {
	return p.ActorID
}
...
func (p *UserServiceClient) GetUser(ctx context.Context, request *UserRequest) (r *UserResponse, err error) {
