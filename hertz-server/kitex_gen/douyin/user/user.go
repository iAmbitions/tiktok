...
type UserRequest struct {
	...
	ActorId int32 `thrift:"actor_id,2" frugal:"2,default,i32" json:"actor_id"`
}
...
func (p *UserRequest) SetUserId(val int32) {
	p.UserId = val
}
func (p *UserRequest) SetActorId(val int32) {
	p.ActorId = val
}
...
func (p *UserRequest) Field1DeepEqual(src int32) bool {
...
func (p *UserRequest) Field2DeepEqual(src int32) bool {
