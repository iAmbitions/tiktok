...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.messageDo.UseModel(&dao.Message{})
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*dao.Message) error
	CreateInBatches(values []*dao.Message, batchSize int) error
	Save(values ...*dao.Message) error
	First() (*dao.Message, error)
	Take() (*dao.Message, error)
	Last() (*dao.Message, error)
	Find() ([]*dao.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Message, err error)
	FindInBatches(result *[]*dao.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dao.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dao.Message, error)
	FirstOrCreate() (*dao.Message, error)
	FindByPage(offset int, limit int) (result []*dao.Message, count int64, err error)
...
func (m messageDo) Create(values ...*dao.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*dao.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*dao.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*dao.Message, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dao.Message), nil
	}
}

func (m messageDo) Take() (*dao.Message, error) {
...
func (m messageDo) Last() (*dao.Message, error) {
...
func (m messageDo) Find() ([]*dao.Message, error) {
	result, err := m.DO.Find()
	return result.([]*dao.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Message, err error) {
	buf := make([]*dao.Message, 0, batchSize)
...
func (m messageDo) FindInBatches(result *[]*dao.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*dao.Message, error) {
...
func (m messageDo) FirstOrCreate() (*dao.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*dao.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*dao.Message) (result gen.ResultInfo, err error) {
