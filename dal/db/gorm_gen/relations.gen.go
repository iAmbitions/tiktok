...
func newRelation(db *gorm.DB, opts ...gen.DOOption) relation {
	...
	_relation.relationDo.UseModel(&dao.Relation{})
	...
	_relation.FromUserID = field.NewInt64(tableName, "from_user_id")
	_relation.ToUserID = field.NewInt64(tableName, "to_user_id")
	_relation.IsFollow = field.NewBool(tableName, "is_follow")
	_relation.PrimaryKey = field.NewString(tableName, "primary_key")
...
func (r *relation) updateTableName(table string) *relation {
	...
	r.FromUserID = field.NewInt64(table, "from_user_id")
	r.ToUserID = field.NewInt64(table, "to_user_id")
	r.IsFollow = field.NewBool(table, "is_follow")
	r.PrimaryKey = field.NewString(table, "primary_key")
...
func (r *relation) fillFieldMap() {
	...
	r.fieldMap["from_user_id"] = r.FromUserID
	r.fieldMap["to_user_id"] = r.ToUserID
	r.fieldMap["is_follow"] = r.IsFollow
	r.fieldMap["primary_key"] = r.PrimaryKey
}
...
type IRelationDo interface {
	...
	Create(values ...*dao.Relation) error
	CreateInBatches(values []*dao.Relation, batchSize int) error
	Save(values ...*dao.Relation) error
	First() (*dao.Relation, error)
	Take() (*dao.Relation, error)
	Last() (*dao.Relation, error)
	Find() ([]*dao.Relation, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Relation, err error)
	FindInBatches(result *[]*dao.Relation, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dao.Relation) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dao.Relation, error)
	FirstOrCreate() (*dao.Relation, error)
	FindByPage(offset int, limit int) (result []*dao.Relation, count int64, err error)
...
func (r relationDo) Create(values ...*dao.Relation) error {
	if len(values) == 0 {
		return nil
	}
...
func (r relationDo) CreateInBatches(values []*dao.Relation, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r relationDo) Save(values ...*dao.Relation) error {
	if len(values) == 0 {
		return nil
	}
...
func (r relationDo) First() (*dao.Relation, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dao.Relation), nil
	}
}

func (r relationDo) Take() (*dao.Relation, error) {
...
func (r relationDo) Last() (*dao.Relation, error) {
...
func (r relationDo) Find() ([]*dao.Relation, error) {
	result, err := r.DO.Find()
	return result.([]*dao.Relation), err
}

func (r relationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dao.Relation, err error) {
	buf := make([]*dao.Relation, 0, batchSize)
...
func (r relationDo) FindInBatches(result *[]*dao.Relation, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r relationDo) FirstOrInit() (*dao.Relation, error) {
...
func (r relationDo) FirstOrCreate() (*dao.Relation, error) {
...
func (r relationDo) FindByPage(offset int, limit int) (result []*dao.Relation, count int64, err error) {
...
func (r relationDo) Delete(models ...*dao.Relation) (result gen.ResultInfo, err error) {
